...
class ReportCategoryController extends Controller
{
    ...
    public function store(StoreReportCategoryRequest $request)
    {
        ...
        Swal::toast('Data Kategori berhasil ditambahkan', 'Succes')->timerProgressBar();
    ...
    public function update(UpdateReportCategoryRequest $request, string $id)
    {
        ...
        Swal::toast('Data Kategori berhasil diubah', 'Succes')->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast('Data Kategori berhasil dihapus', 'Succes')->timerProgressBar();
